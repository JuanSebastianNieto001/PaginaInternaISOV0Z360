  ...
  return (
    <>
      ...
      <div className="space-y-4">
        <Suspense>
          <DocumentFilters tree={options.tree} documentTypes={options.documentTypes} tags={tags} authors={authors} versions={versions} query={query} basePath="/admin/documents" />
        </Suspense>
